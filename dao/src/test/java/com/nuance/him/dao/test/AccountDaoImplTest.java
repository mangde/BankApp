...
public class AccountDaoImplTest extends AbstractTransactionalTestNGSpringContextTests {
    ...
    @BeforeMethod
    public void setUp() {
        accountDAO = new AccountDaoImpl(namedParameterJdbcTemplate, getOpenAccount, getAccType, getGetBalance, getDepositeAmount, getAccountDetails, getWithdrawAmount);
